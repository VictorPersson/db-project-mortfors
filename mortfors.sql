...
insert into Chaufför values
  (197202095123, 'Petter', 'Måsvägen 23', 072123313),
  ...
  (198909024123, 'Petter', 'Likevägen 99', 070612534),
  (199602096316, 'Victor', 'Lantmannagatan 3B', 0709240058);
...
insert into Tur values
  (001, 198401199182, 150211, 1000, 1600, 5, 20, 'Helsingborg', 'Göteborg'),
  (002, 198401199182, 150518, 0930, 1100, 110, 162, 'Malmö', 'Berlin'),
  (003, 198401199182, 110618, 1330, 1530, 80, 82, 'Göteborg', 'Malmö'),
  (004, 198909024123, 020918, 0815, 1200, 50, 52, 'Mörtfors', 'Löddeköpinge'),
  (005, 198401199182, 090118, 2030, 2345, 100, 74, 'Berlin', 'Paris');
